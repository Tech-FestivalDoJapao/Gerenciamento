...
var DateInputGroup = (0, import_system2.forwardRef)((props, ref) => {
  const {
    as,
    label,
    children,
  ...
  const helperWrapper = (0, import_react4.useMemo)(() => {
    if (!hasHelper)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { ...helperWrapperProps, children: errorMessage ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { ...errorMessageProps, children: errorMessage }) : description ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { ...descriptionProps, children: description }) : null });
  }, [
    hasHelper,
    errorMessage,
    description,
...
var time_input_default = (0, import_system3.forwardRef)(TimeInput);
