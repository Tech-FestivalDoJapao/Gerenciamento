...
type UseCheckboxGroupProps = Omit<Props, "onChange"> & Omit<AriaCheckboxGroupProps, "validationBehavior"> & Partial<Pick<CheckboxProps, "color" | "size" | "radius" | "lineThrough" | "isDisabled" | "disableAnimation">>;
type ContextType = {
