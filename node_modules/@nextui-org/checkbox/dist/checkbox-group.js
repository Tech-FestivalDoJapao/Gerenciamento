...
var CheckboxGroup = (0, import_system.forwardRef)((props, ref) => {
  ...
  const errorMessageContent = (0, import_react2.useMemo)(() => errorMessage, [isInvalid]);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ...getGroupProps(), children: [
    ...
    isInvalid && errorMessageContent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...getErrorMessageProps(), children: errorMessageContent }) : description ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...getDescriptionProps(), children: description }) : null
  ] });
});
