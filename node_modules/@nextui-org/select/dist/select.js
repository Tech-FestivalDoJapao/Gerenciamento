...
function useSelect(originalProps) {
  ...
  const slots = (0, import_react.useMemo)(
    ...
    [(0, import_shared_utils.objectToDeps)(variantProps), isInvalid, labelPlacement, className]
  );
...
function Select(props, ref) {
  ...
  const popoverContent = (0, import_react2.useMemo)(
    () => state.isOpen ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      import_popover.FreeSoloPopover,
      {
        ...
        state,
        triggerRef,
        children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_scroll_shadow.ScrollShadow, { ...getListboxWrapperProps(), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_listbox.Listbox, { ...getListboxProps() }) })
      }
    ) : null,
